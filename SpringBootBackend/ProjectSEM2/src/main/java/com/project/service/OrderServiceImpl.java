...
public class OrderServiceImpl implements OrderService {
    ...
    private final CustomerRepository customerRepository; // To fetch customer if needed
    private final ProductRepository productRepository;   // To validate products and update stock
    ...
    @Override
    @Transactional // Important for operations involving multiple entities
